...
import { EntretienDialogComponent } from '../../../../../../main/webapp/app/entities/entretien/entretien-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Entretien Management Dialog Component', () => {
        let comp: EntretienDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(EntretienDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'entretienListModification', content: 'OK'});
