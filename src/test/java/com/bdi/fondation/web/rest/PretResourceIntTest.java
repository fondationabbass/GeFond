...
public class PretResourceIntTest {
    ...
    @Test
    @Transactional
    public void checkMontAaccordIsRequired() throws Exception {
        int databaseSizeBeforeTest = pretRepository.findAll().size();
        // set the field null
        pret.setMontAaccord(null);
    ...
    @Test
    @Transactional
    public void checkMontDebloqIsRequired() throws Exception {
        int databaseSizeBeforeTest = pretRepository.findAll().size();
        // set the field null
        pret.setMontDebloq(null);
    ...
    @Test
    @Transactional
    public void checkNbrEcheanceIsRequired() throws Exception {
        int databaseSizeBeforeTest = pretRepository.findAll().size();
        // set the field null
        pret.setNbrEcheance(null);
    ...
    @Test
    @Transactional
    public void checkDatePremiereEcheanceIsRequired() throws Exception {
        int databaseSizeBeforeTest = pretRepository.findAll().size();
        // set the field null
        pret.setDatePremiereEcheance(null);
    ...
    @Test
    @Transactional
    public void checkDateDerniereEcheanceIsRequired() throws Exception {
        int databaseSizeBeforeTest = pretRepository.findAll().size();
        // set the field null
        pret.setDateDerniereEcheance(null);
    ...
    @Test
    @Transactional
    public void checkDateDernierDebloqIsRequired() throws Exception {
        int databaseSizeBeforeTest = pretRepository.findAll().size();
        // set the field null
        pret.setDateDernierDebloq(null);
